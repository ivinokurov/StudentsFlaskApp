...
CREATE TABLE dbo.StudentGroup (
     ...
     deptId int NOT NULL FOREIGN KEY REFERENCES dbo.Department (id)  ON UPDATE CASCADE ON DELETE CASCADE 
)
...
CREATE TABLE dbo.Student (
     ...
     groupId int NOT NULL FOREIGN KEY REFERENCES dbo.StudentGroup (id) ON UPDATE CASCADE ON DELETE CASCADE
)
